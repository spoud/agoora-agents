...
class DataServiceTest {
  ...
  private static final String SCHEMA_1 =
      "{\"type\":\"object\",\"properties\":{\"installed_rank\":{\"type\":\"int4\"},\"version\":{\"type\":\"varchar\"},\"description\":{\"type\":\"varchar\"},\"type\":{\"type\":\"varchar\"},\"script\":{\"type\":\"varchar\"},\"checksum\":{\"type\":\"int4\"},\"installed_by\":{\"type\":\"varchar\"},\"installed_on\":{\"type\":\"timestamp\"},\"execution_time\":{\"type\":\"int4\"},\"success\":{\"type\":\"bool\"}},\"required\":[\"installed_rank\",\"description\",\"type\",\"script\",\"installed_by\",\"installed_on\",\"execution_time\",\"success\"],\"$schema\":\"http://json-schema.org/schema#\"}";
  private static final String SCHEMA_2 =
      "{\"type\":\"object\",\"properties\":{\"address_uuid\":{\"type\":\"uuid\"},\"label\":{\"type\":\"varchar\"},\"line1\":{\"type\":\"varchar\"},\"line2\":{\"type\":\"varchar\"},\"meta\":{\"type\":\"text\"},\"created\":{\"type\":\"timestamp\"},\"updated\":{\"type\":\"timestamp\"},\"created_by\":{\"type\":\"varchar\"},\"updated_by\":{\"type\":\"varchar\"},\"city_uuid\":{\"type\":\"uuid\"}},\"required\":[\"address_uuid\",\"label\",\"line1\",\"created\",\"updated\",\"created_by\",\"updated_by\",\"city_uuid\"],\"$schema\":\"http://json-schema.org/schema#\"}";
  private static final String SCHEMA_3 =
      "{\"type\":\"object\",\"properties\":{\"city_uuid\":{\"type\":\"uuid\"},\"label\":{\"type\":\"varchar\"},\"meta\":{\"type\":\"text\"},\"created\":{\"type\":\"timestamp\"},\"updated\":{\"type\":\"timestamp\"},\"created_by\":{\"type\":\"varchar\"},\"updated_by\":{\"type\":\"varchar\"}},\"required\":[\"city_uuid\",\"label\",\"created\",\"updated\",\"created_by\",\"updated_by\"],\"$schema\":\"http://json-schema.org/schema#\"}";
  @Inject
